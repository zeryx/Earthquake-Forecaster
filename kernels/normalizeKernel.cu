...
__global__ void normalizeKern(kernelArray<double> vect, kernelArray<int> params, double *avgFitness,  int device_offset){
    ...
    vect.array[fitnessval] = vect.array[fitnessval];
