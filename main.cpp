...
int main(int argc, char** arg){
    ...
    hostRamPercentageMap["genetics"] = 0.30;
    hostRamPercentageMap["input & training"] = 0.70; // the bulk of the host memory should contain input & training data.
    ...
    NetworkGenetic ConstructedNetwork(inputs, hidden, memory, outputs, hidden_layers,  connections, "../mount/data");
