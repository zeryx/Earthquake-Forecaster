...
public:
    ...
    void importSitesData(std::string siteInfo);
    void importKpData(std::string Kp);
private:
    ...
    thrust::device_vector<float> _DKpIndex; //device loaded memory object containing the planetary magnetic activity index. (all of it should fit)
